...
if (limit > 10) {
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`Yazma limiti **${limit}** saniye olarak Ayarlandı!`).setColor('RANDOM'));
...
request({
  ...
  enabled: true,
  guildOnly: false,
  aliases: ["slow-mode", "slowmode", "yavas-mod", 'yavasmod', 'yavaşmod', 'yavaş'],
  permLevel: 3,
};
